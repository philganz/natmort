...
pathR <- getwd()
pathOM <- paste(substr(pathR,1,nchar(pathR)-43),"om/sablefish",sep="")
pathEM <- paste(substr(pathR,1,nchar(pathR)-43),"em/sablefish",sep="")
...
# in .tpl:
# change M_devs from random_effects_vector to init_bounded_vector
# comment out prior
