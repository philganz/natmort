...
//===================================================================================================
  ...
  n = 2*nyrs + 2*nyrs*nages;
  param = initial_params::nvarcalc();
  AIC = 2*obj_fun+2*param;
